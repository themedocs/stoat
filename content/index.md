...
- **Demo:** [live demo site](https://stoat.owldraft.com)
...
Example - a full-bleed cover page: [page-with-cover](https://stoat.owldraft.com/page-with-cover/) is just a Page with the title hidden, using the Gutenberg **Cover** block as content.
...
Example: [Demo search page](https://stoat.owldraft.com/search/).
